...
namespace Microsoft.AspNetCore.Authentication.OpenStreetMap
{
    ...
    /// </summary>
    public class OpenStreetMapMiddleware : AuthenticationMiddleware<OpenStreetMapOptions>
    {
        private readonly HttpClient _httpClient;

        /// <summary>
        /// Initializes a <see cref="OpenStreetMapMiddleware"/>
        /// </summary>
        ...
        public OpenStreetMapMiddleware(
            ...
            : base(next, options, loggerFactory, encoder)
        {
            ...
            {
                Options.Events = new OpenStreetMapEvents();
            }
            if (Options.StateDataFormat == null)
            {
                var dataProtector = dataProtectionProvider.CreateProtector(
                    typeof(OpenStreetMapMiddleware).FullName, Options.AuthenticationScheme, "v1");
            ...
            _httpClient.DefaultRequestHeaders.UserAgent.ParseAdd("Microsoft ASP.NET Core OpenStreetMap middleware");
        ...
        /// </summary>
        /// <returns>An <see cref="AuthenticationHandler{T}"/> configured with the <see cref="OpenStreetMapOptions"/> supplied to the constructor.</returns>
        protected override AuthenticationHandler<OpenStreetMapOptions> CreateHandler()
        {
            return new OpenStreetMapHandler(_httpClient);
        }
    }
}
