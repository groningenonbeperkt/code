...
namespace TagEditor.OpenStreetMap
{
    ...
    {
        private string BaseUrl =  "https://master.apis.dev.openstreetmap.org"; //<-- aanpassen naar  https://api.openstreetmap.org
        ...
        public void SetDebug(bool debugMode)
        {
            if (debugMode)
                ...
                BaseUrl = "https://master.apis.dev.openstreetmap.org"; //<-- aanpassen naar  https://api.openstreetmap.org
