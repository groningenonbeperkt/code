                ...
                module.exports = {
                    "class": L.Control.extend({
                        ...
                        markGeocode: function (result) {
                            ...
                            //this._geocodeMarker.on('click', function (e) {
                            //    $('#informationContent').html('hoi');
                            //});

                            var _this = this;
                            this._geocodeMarker.once("dblclick", function () {
                                _this._map.removeLayer(_this._geocodeMarker);
                                $('#searchFieldInformationLabel').text('');
                                _this._geocodeMarker = null;
                            });

                            $('#searchFieldInformationLabel').text('Dubbel klik op de marker om te verwijderen.');
                ...
                module.exports = {
                    "class": L.Class.extend({
                        ...
                        initialize: function (apiKey, options) {
                            L.Util.setOptions(this, options);
                            this._apiKey = apiKey;
                            this.options.geocodingQueryParams = options;
                            this._lastSuggest = 0;
                        },
                        ...
                        geocode: function (query, cb, context) {
                            ...
                            Util.getJSON(this.options.serviceUrl + "/search", L.extend({
                                ...
                                cb.call(context, _this._parseResults(_this, data, "bbox"));
                            });
                        },
                        ...
                        reverse: function (location, scale, cb, context) {
                            ...
                            Util.getJSON(this.options.serviceUrl + "/reverse", L.extend({
                                ...
                                cb.call(context, _this._parseResults(_this, data, "bounds"));
                            });
                        },

                        _parseResults: function (_this, data, bboxname) {
                            var results = [];
                            L.geoJson(data, {
                                ...
                                onEachFeature: function (feature, layer) {
                                    ...
                                    if (_this.options["boundary.country"] == 'NL') {
                                        layer.feature.properties.label = layer.feature.properties.label.replace('Netherlands', 'Nederland');
                                    }
