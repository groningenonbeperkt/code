...
{
    /// <summary>
    /// Serializes and deserializes Openstreetmap request and access tokens so that they can be used by other application components.
    /// </summary>
    public class RequestTokenSerializer : IDataSerializer<RequestToken>
    {
        ...
        /// <returns>The Openstreetmap request token</returns>
        ...
        /// <summary>
        /// Writes a Openstreetmap request token as a series of bytes. Used by the <see cref="Serialize"/> method.
        /// </summary>
        ...
        /// <summary>
        /// Reads a Openstreetmap request token from a series of bytes. Used by the <see cref="Deserialize"/> method.
        /// </summary>
