...
namespace GroniningenOnbeperkt.NetCore.TagEditor.Openstreetmap
{
    ...
    {
        private string BaseUrl = "https://api.openstreetmap.org"; //<-- aanpassen naar  
        ...
        private bool _useDevelopmentUrls = false;
        ...
        public bool UseDevelopmentUrls
        {
            get
            {
                return this._useDevelopmentUrls;
            }
            set
            {
                this._useDevelopmentUrls = value;

                if(this._useDevelopmentUrls)
                {
